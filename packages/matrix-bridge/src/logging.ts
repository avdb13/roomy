...
export class Logger {
  ...
  public static request(config: RequestConfig): RequestLogger {
    ...
    return {
      debug: (msg: string, ...meta: any[]) => { decorate(base.debug, [msg, ...meta]); },
      info: (msg: string, ...meta: any[]) => { decorate(base.info, [msg, ...meta]); },
      warn: (msg: string, ...meta: any[]) => { decorate(base.warn, [msg, ...meta]); },
      error: (msg: string, ...meta: any[]) => { decorate(base.error, [msg, ...meta]); },
    };
  }
