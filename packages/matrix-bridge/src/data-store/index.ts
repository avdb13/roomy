import { MatrixRoom, ProvisioningStore, RoomBridgeStoreEntry as Entry } from "matrix-appservice-bridge";
...
export interface DataStore extends ProvisioningStore {
  ...
  getRoom(matrixRoomId: string, roomySpaceId: string, roomyChannelId?: string): Promise<Entry | null>;
